...
| File                                  | Description                                                                                          |
| ------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `TASK_3_Diabetes_Prediction_Model.py` | Main Python script containing feature engineering, encoding, scaling, model training, and evaluation |
| `dataset_37_diabetes.csv`             | PIMA Indians Diabetes Dataset used for model training                                                |
| `Output TASK 3.png`                   | Feature Importance visualization generated by the Random Forest model                                |
